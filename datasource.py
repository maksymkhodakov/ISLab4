...
SUBJECTS = [ {"name":"Algorithms", "number_of_students": 60, "groups": 3, "teacher":"James Web"},
			 ...
			 {"name":"IT", "number_of_students": 60, "groups": 3,"teacher":"Jane Doe"},
...
SPECIALITIES = [{"name":"KN", "subjects": ["Algorithms", "Algebra", "Mmoz", "Mopi", "Android"]},
				{"name":"IPZ", "subjects":["Algorithms", "AI", "IT", "IOS", "C++"]},
				{"name":"PRYMAT", "subjects":["Algebra", "IT", "C++", "IOS", "Android"]}]
